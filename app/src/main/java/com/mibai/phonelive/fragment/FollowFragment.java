...
public class FollowFragment extends AbsFragment implements OnItemClickListener<VideoBean> {
    ...
    public void onItemClick(VideoBean bean, int position) {
        if (mRefreshView != null && bean != null && bean.getUserinfo() != null) {
            VideoPlayActivity.forwardVideoPlay(mContext, Constants.VIDEO_FOLLOW, position, mRefreshView.getPage(), bean.getUserinfo(), bean.getIsattent(),Constants.FOLLOW_TYPE);
        }
    }
