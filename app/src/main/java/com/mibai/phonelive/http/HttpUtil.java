package com.mibai.phonelive.http;
...
import com.mibai.phonelive.bean.TxLocationBean;
import com.mibai.phonelive.bean.TxLocationPoiBean;
...
public class HttpUtil {
    ...
    public static final String HTTP_URL = AppConfig.HOST + "/api/public/?";
    ...
    public static final String GET_TYPE_VIDEO_LIST = "getCategoryVideo";
    ...
    public static final String GET_BUY_VIDEOS = "getBuyVideos";
    ...
    public static final String GET_AD_LISTS = "getAdLists";
    public static final String NOT_LOGIN = "TouristLogin";
     ...
     * 获取分类视频列表
     */
    public static void getTypeVideoList(int p, String cid, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Category.getCategoryVideo")
                .params("cid", cid)
                .params("p", p)
                .tag(GET_TYPE_VIDEO_LIST)
                .execute(callback);
    }
     ...
     * 获取附近视频列表
     */
    public static void getNearbyVideos(String lng, String lat, int p, HttpCallback callback) {
     ...
     * @param touid 对方的id
     */
    public static void getBuyVideos(String touid, int p, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Video.buyVideolist")
                .headers("Connection", CONNECTION)
                .params("uid", touid)
                .params("p", p)
                .tag(GET_BUY_VIDEOS)
    ...
    public static void getVideoInfo(String videoid, String tag, HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Video.getVideos")
                .headers("Connection", CONNECTION)
                .params("uid", AppConfig.getInstance().getUid())
    ...
    //短视频上传信息
    public static void uploadVideo(String lat, String lng, String city, String title, String thumb, String href, int musicId, int ispass, String type, String videoid, String cate, String money, HttpCallback callback) {
    ...
    // 获取广告banner
    public static void getTypeAdvert(HttpCallback callback) {
        OkGo.<JsonBean>get(HTTP_URL + "service=Ad.getAdLists")
                .tag(GET_AD_LISTS)
                .execute(callback);
    }
