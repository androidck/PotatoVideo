...
public class Constants {
    ...
    public static final String YB_NAME_1 = "玉米社区";
    ...
    public static final String NOT_LOGIN_TYPE = "tourist";
    // 标识
    public static final String IDENTIFYING = "identifying";

    // 推荐标识
    public static final int RECOMMEND_TYPE = 888;
    // 分类标识
    public static final int TYPE_TYPE = 999;
    // 关注标识
    public static final int FOLLOW_TYPE = 666;
    // 热门标识
    public static final int HOT = 777;
    // 搜索
    public static final int SEARCH_TYPE = 111;

    // 附近
    public static final int NEAR_TYPE = 222;
